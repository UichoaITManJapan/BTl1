...
public  class Library {
    ...
    public static void libraryMenu(){
        List<Category> categoryLists = FileManager.loadDataFromFile("categories.txt");
        List<Book> bookList = FileManager.loadDataFromFile("books.txt");
        do {
            ...
            try {
                ...
                switch (choice){
                    case 1:
                        ...
                        FileManager.saveDataToFile("categories.txt",categoryLists);
                        break;
                    case 2:
                       BookMenu.bookMenu();
                       FileManager.saveDataToFile("books.txt",bookList);
                       break;
                    case 3:
                        System.exit(0);
                    default:
