...
import static ra.entity.Category.*;
import static ra.entity.Category.categoryList;
...
public class Book implements IEntity, Serializable {
    ...
    private String catalogName; // thêm tên danh mục cho người dùng dễ đọc
    ...
    public String validateBookAuthor(){
    ...
    public String validateBookPusblisher(){
    ...
    public String validateBookDescription(){
    ...
    public void choiceCatalog(){
        ...
        System.out.println("Chọn tên danh mục :");
        try {
            int choice = Integer.parseInt(scanner.nextLine());
            this.catalogId = categoryList.get(choice-1).getId();
            // thêm tên của danh mục cho người dùng dễ đọc
            this.catalogName = categoryList.get(choice-1).getName();
    ...
    @Override
    public void output() {
        System.out.println("Mã sách : " +this.id + "\t" + "Tác giả :" +this.author);
        System.out.println("Tiêu đề sách : " +this.title);
        System.out.println("NXB :" +this.publisher +"\t" + "Năm xuất bản :" +this.year);
        System.out.println("Mô tả sách :" + this.description);
        System.out.println("Mã thể loại sách : " +this.catalogId + "\t"+"Tên thể loại sách : " +this.catalogName);
        System.out.println("=======================================================");
    }
}
